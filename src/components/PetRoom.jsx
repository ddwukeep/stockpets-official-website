...
export default function PetRoom({ pet, reaction, levelUp, onPet }) {
  return <div className="room"><div className="amber-haze"/><div className="spark-field" aria-hidden="true"><i/><i/><i/><i/><i/><i/><i/></div><div className="room-glow"/>
    <button className="pet-button" type="button" onClick={onPet} aria-label="Pet your NVDA companion"><Pet stage={pet.stage} reaction={reaction}/></button>
    <div className="shell shell-left"><i/><i/><i/></div><div className="shell shell-right"><i/><i/><i/></div>
